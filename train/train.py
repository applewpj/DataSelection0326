...
from transformers import (AutoModelForCausalLM, AutoTokenizer,
                          ...
                          set_seed)
sys.path.append("/mnt/petrelfs/wangpingjie/DataSelection/MY")
# pdb.set_trace()
from data_processing.get_training_dataset import get_training_dataset
...
def main():
    ...
    for name in os.listdir(training_args.output_dir):
        if "checkpoint-" in name:
            resume_from_checkpoint = os.path.join(training_args.output_dir, name)
